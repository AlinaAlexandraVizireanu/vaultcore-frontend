    ...
    terms: [
      {
        term: "Stock",
        definition:
          "A security that represents ownership in a company and a claim on part of its assets and earnings.",
      },
      {
        term: "Bond",
        definition:
      ...
      },
      {
        term: "ETF",
        definition:
          "An Exchange-Traded Fund that holds a collection of assets and trades like a stock on an exchange.",
      },
      {
        term: "Mutual Fund",
        definition:
          "An investment vehicle made up of a pool of funds collected from many investors to invest in securities.",
      },
      {
        term: "Dividend",
        definition:
      ...
      },
      {
        ...
        definition:
          "The total value of a company’s shares of stock, calculated by multiplying share price by number of shares.",
      },
      {
        term: "Bull Market",
        definition:
      ...
      },
      {
        term: "P/E Ratio",
        definition:
          "Price-to-Earnings Ratio, a valuation measure comparing the current share price to its per-share earnings.",
      },
      {
        term: "Portfolio",
        definition:
          "A collection of financial investments like stocks, bonds, and ETFs.",
      },
      {
      ...
      },
      {
        term: "IPO",
        definition:
          "Initial Public Offering – the first time a company's stock becomes available to the public.",
      },
      {
        term: "Ticker Symbol",
        definition:
          "A unique series of letters representing a particular stock on an exchange.",
      },
      {
        term: "Stop Loss",
        definition:
    ...
    content: [
      {
        ...
        body: "Sign up using your email and a secure password to get started. Once registered, you'll have access to all app features including your own portfolio.",
      },
      {
        heading: "Navigating the Dashboard",
        body: "Use the tabs to access your Portfolio, Orders, Activity, News, and Education sections. Each tab is designed to help you manage your investments with ease.",
      },
      {
        heading: "Searching for a Stock",
        body: "Use the search bar to find stocks by name or ticker. Click a result to view its summary, chart, and buy options.",
      },
      {
        heading: "Placing a Simulated Order",
        body: "Select a stock, click 'Buy', enter the amount or quantity, and confirm your order. You can view your purchases in the Portfolio tab.",
      },
      {
        heading: "Reading Stock Charts",
        body: "You can toggle between line and candlestick charts. Use them to view historical trends and make informed decisions.",
      },
      {
        heading: "Tracking Your Portfolio",
        body: "View the stocks you own, including quantity, average price, and total value. Your portfolio updates automatically after each order.",
      },
      {
        heading: "Using the Education Section",
        body: "Explore beginner-friendly guides, strategies, and glossary terms to strengthen your financial knowledge.",
      },
      {
        heading: "Viewing News and Tips",
        body: "Stay informed with curated news and daily insights tailored to investors. Access this from the News tab.",
      },
      {
        heading: "Troubleshooting",
        body: "If you run into issues like missing orders or loading errors, try refreshing the page or checking your internet connection. Contact support if the issue persists.",
      },
    ],
  },
};
